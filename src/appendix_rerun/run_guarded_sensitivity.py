...
This runner imports the SHA-256 guarded cached-LP Local Search module
src/test/test_FCPLS_score_cached_lp.py (see provenance/FIGURE11_SOURCE_GUARD.md).
It does not import LS_Path_Test.py.
"""
...
GUARD_NOTE = CODE_ROOT / "provenance/FIGURE11_SOURCE_GUARD.md"
