...
sample_counts = np.array([100, 100, 50, 30])

# FCP Data (n=20), updated from the latest evaluation output.
fcp_m_rev_mean = np.array([1.1614, 1.1739, 1.1801, 1.1833])
fcp_m_rev_std = np.array([0.0322, 0.0301, 0.0271, 0.0203])
fcp_m_time_mean = np.array([0.1025, 1.5920, 25.4524, 162.0471])

# BSP baseline data (n=20).
bsp_m_rev_mean = np.ones_like(m_values, dtype=float)
bsp_m_time_mean = np.array([0.9099, 8.3444, 110.6577, 418.2795])
