...
def run_one_model(mdl, data, n, m_segments):
    """Single-model forward pass returning the thresholded assortment; thresholding time is not counted."""
    with torch.no_grad():
...
def main():
    ...
    parser.add_argument("--result_dir", type=str, default="results/fcp", help="Output directory")
