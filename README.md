# Bundle-pricing reproduction package
...
Seven experiment packages are published below; Tables 3–4 and Figures 6–8 are not
part of this release. See [acceptance scope](docs/ACCEPTANCE.md)
...
```bash
git clone https://github.com/CW030811/bundle-experiment-reproducibility.git
cd bundle-experiment-reproducibility
...
- `experiments/`: paper-specific commands and scope.
...
the evidence required to add another accepted experiment.

## 中文说明

当前公开 7 项已验收实验的源码、数据/模型压缩包与参考结果；本版本不含
Table 3、4 和 Figure 6、7、8。运行时间不要求一致；
